...
if($link) {
    ...
    FROM lots l JOIN category c ON l.id_category = c.id_lot LEFT JOIN bets b ON l.id = b.id_lot WHERE l.date_close > NOW() GROUP BY l.id ORDER BY l.date_create DESC';
