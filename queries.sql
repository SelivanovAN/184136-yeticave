...
SELECT l.id, l.name, l.start_price, l.picture, MAX(b.price_buy), MAX(c.name), l.date_create, l.date_close FROM lots l JOIN category c ON l.id_category = c.id_lot JOIN bets b ON l.id = b.id_lot GROUP BY l.id ORDER BY l.date_create DESC;
